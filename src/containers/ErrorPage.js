...
class ErrorPage extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      errorMsg: "This page has either been removed, renamed or is unavailable. We hope to resolve this issue soon! In the meantime, feel free to explore other parts of our site or contact our customer support.",
      hideErrorMsg: false,
      refreshBtn: false,
    };
  }
  ...
  getErrorImg(type) {
    const { shop: { contentful } } = this.props
    switch (type) {
      case "confirmation":
  ...
  render() {
    const { errorTitle, errorMsg, hideErrorMsg, errorType, refreshBtn } = this.state
    return (
      <div className="error-page">
        <div className="container content body has-text-centered">
          <img src={this.getErrorImg(errorType)} alt="error-img" className="error-img" />
