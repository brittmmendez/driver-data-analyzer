        ...
        {!shop.cart.coupon.promo && (
          <Formik
            ...
            onSubmit={async (promoCode, { setSubmitting }) => {
              shop.cart.coupon.applyPromo(promoCode.promo).then(response => {
                if (response) {
                  this.setState(
                    {
                      success: true
            ...
            {({ isSubmitting }) => (
              <Form onClick={this.handleFormClick}>
                <div className="field is-grouped is-marginless">
                  <div className="control is-expanded is-marginless">
                    <Field
                      disabled={success}
                      className={
                        shop.cart.coupon.error ? 'error-form input' : 'input'
                      }
                      type="promo"
                      name="promo"
                ...
                {shop.cart.coupon.error && (
                  <p className="error">{shop.cart.coupon.errorMesage}</p>
                )}
                <p className="has-text-left is-marginless sub-text">
                  {' '}
        ...
        {shop.cart.coupon.promo && (
          <div>
            <div className="promo-applied">
              ...
              <div className="promo-msg">{shop.cart.coupon.name}</div>
            </div>
            <p className="has-text-left is-marginless sub-text">
              {' '}
              One promo code per order
